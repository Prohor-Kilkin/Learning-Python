...
curl_command = 'curl -X GET "https://www.wildberries.ru/catalog/elektronika/muzyka-i-video" -H "Content-Type: application/json"'
curlconverter = curlconverter.CurlConverter(curl_command)

python_code = curlconverter.convert()

# response = requests.get(url, headers=python_code['headers'], params=python_code['params'])
